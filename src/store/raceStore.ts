...
export const MEN_RACES: RaceDetails[] = [
  ...
  {
    id: "cadel-evans-great-ocean-road-race-men",
    name: "Cadel Evans Great Ocean Road Race - Men",
    countryCode: "AU",
  ...
  {
    id: "ronde-van-brugge",
    name: "Ronde Van Brugge - Tour of Bruges",
    countryCode: "BE",
  ...
  {
    id: "gent-wevelgem",
    name: "In Flanders Fields - From Middelkerke to Wevelgem",
    countryCode: "BE",
  ...
  {
    id: "dwars-door-vlaanderen",
    name: "Dwars door Vlaanderen - A travers la Flandre",
    countryCode: "BE",
  ...
  {
    id: "paris-roubaix",
    name: "Paris–Roubaix Hauts-de-France",
    countryCode: "FR",
    ...
    stages: [
      {
        ...
        stageType: "Flat",
        date: "2026-07-04",
        profileImage: "https://via.placeholder.com/1200x360.png?text=Tour+de+France+Stage+1",
      },
      {
        stageNumber: 2,
        ...
        stageType: "Hill",
        date: "2026-07-05",
        profileImage: "https://via.placeholder.com/1200x360.png?text=Tour+de+France+Stage+2",
      },
    ],
  },
  {
...
export const ALL_RACES: RaceDetails[] = [...MEN_RACES, ...WOMEN_RACES];

export const RACES_BY_ID: Record<string, RaceDetails> = Object.fromEntries(
...
export function buildMockStages(race: RaceDetails): Stage[] {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      profileImage:
        "https://via.placeholder.com/1200x360.png?text=Stage+profile",
    };
  });
}